...
i_version( frener_and_refier, `21 January 2015` ).
...
%=======================================================================
	...
	q0n(line), generic_horizontal_details( [ [ `CIG`, `/`, `CUP`, `:` ], cigcup, s1 ] )
	
	, check( sys_string_split( cigcup, `/`, [ Cig, Cup ] ) )
...
%=======================================================================
	...
	, qn0( [ append( customer_comments(s1), ` `, `` ), tab ] )
