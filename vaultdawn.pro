...
i_version( vaultdawn, `06 February 2015` ).
...
%	, buyer_registration_number( `shipping` )
	...
	, buyer_registration_number( `GB-VAULTDN` )
...
%=======================================================================
	...
	, or( [ [ `NEW`, `SHIP`, `-`, `TO`, set(new_ship_to), trace( [ `new ship to` ] ) ]
...
%=======================================================================
	...
	, delivery_location(f( [ begin, q(dec,3,3), end ] ) )
