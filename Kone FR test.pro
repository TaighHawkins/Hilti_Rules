...
%	, buyer_registration_number( `Customer` )
	...
	, suppliers_code_for_buyer( `10558391` )     % TEST
...
%=======================================================================
	...
	`Devise`, tab, `Tot`, `.`, `Hors`, `Taxe`,  newline
...
%=======================================================================
	...
	`Pos`, `.`, `Ref`, tab, `Date`, `livr`, `.`, tab, `Quant`
