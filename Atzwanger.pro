...
i_version( atzwanger, `15 October 2014` ).
...
%=======================================================================
i_rule( create_address_line, [ 
%=======================================================================

	with( invoice, shipping_instructions, InstrX )
	, check( strip_string2_from_string1( InstrX, ` `, Instr ) )
	
	, q(0,20,line)
	
	, generic_horizontal_details( [ [ `Nr`, `.`, `Cup`, `:` ], 250, cup, s1 ] )
	, check( cup = Cup )
	
	, check( strcat_list( [ Instr, ` CUP:`, Cup ], AL ) )
