...
i_version( mortenson_construction, `15 January 2014` ).
...
%	, suppliers_code_for_buyer( `10776472` )  %PROD
	, suppliers_code_for_buyer( `10478686` )  %TEST

%	, customer_comments( `Customer Comments` )
%	, [ q0n(line), customer_comments_attn ] 

%	, [ q0n(line), customer_comments_phone ] 

%	, [ q0n(line), customer_comments_fax ] 

	, get_customer_comments

	, get_shipping_instructions

%	, [ q0n(line), shipping_instructions_attn ] 

%	, [ q0n(line), shipping_instructions_phone ] 

%	, [ q0n(line), shipping_instructions_fax ] 
...
%=======================================================================
	...
	, or([ get_item_line, line_item(`Missing`) ])
...
%=======================================================================
i_line_rule_cut( get_item_line, [
%=======================================================================

	 line_item( f([begin, q(dec,3,9), end ]) )
